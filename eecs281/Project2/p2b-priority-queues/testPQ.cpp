...
void testPairing() {
...

    {
        ...
        std::cout << "Range OK\n";
        // Copy constructor
        PairingPQ<int> pairing2 { pairing1 };// { pairing1 };
        ...
        PairingPQ<int> pq4v{ v.cbegin(), v.cend() };
        std::cout << "plz be right, top: " << pq4v.top() << "\n";
        std::cout << "plz be right, size: " << pq4v.size() << "\n";
        pq4v.pop();
        pq4v.pop();
        pq4v.pop();
        pq4v.pop();
        ...
        std::cout << "real size is: " << times << "\n";
        //std::cout << "plz be right 2, top: " << pq4v.top() << "\n";
        std::cout << "plz be right 2, size: " << pq4v.size() << "\n";
        PairingPQ<int> pq4copy{ pq4v };
        std::cout << "plz be right again, top: " << pq4copy.top() << "\n";
        std::cout << "plz be right again, size: " << pq4copy.size() << "\n";
        pq1.push(0);
        pq1.pop();
        pq1.push(100);
        pq1.push(50);
        ...
        pq3 = pairing1;
        assert(pq1.top() == 95);
        std::cout << "let's see what's happening, top: " << pairing1.top() << "\n";
        std::cout << "let's see what's happening, size: " << pairing1.size() << "\n";
        PairingPQ<int> pq4 { pairing1 };
        //pq4 = pairing1;
        std::cout << "let's see what's next, top: " << pq4.top() << "\n";
        std::cout << "let's see what's next, size: " << pq4.size() << "\n";
        std::cout << "let's see what's in pq3, top: " << pq3.top() << "\n";
        std::cout << "let's see what's in pq3, size: " << pq3.size() << "\n";
        assert(pq3.top() == 95);
        pq3.pop();
        pq3.pop();
        assert(pq3.top() == 85);
